...
<div class="section">
  ...
  <div class="section">
    <h3>Overview</h3>
    <h4>Information</h4>
    <p>The debugger framework was deployed through the experimentation tool. Therfore, when the tool was active, the debugger was accessible. Users could activate the application through the console or by adding <code>awoDebug=true</code> as a URL parameter. Once enabled, the debugger would appear in the top-right corner of the browser. The application maintains its state through the utilization of cookies and local storage.</p>
