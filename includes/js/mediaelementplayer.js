			...
			case 'vimeo':
				...
				container.innerHTML =
					'<object width="' + width + '" height="' + height + '">' +
						...
						'<embed src="//vimeo.com/moogaloop.swf?api=1&amp;clip_id=' + pluginMediaElement.vimeoid + '&amp;server=vimeo.com&amp;show_title=0&amp;show_byline=0&amp;show_portrait=0&amp;color=00adef&amp;fullscreen=1&amp;autoplay=0&amp;loop=0&amp;autoplay=0" type="application/x-shockwave-flash" allowfullscreen="true" allowscriptaccess="always" wmode="transparent" width="' + width + '" height="' + height + '"></embed>' +
					'</object>';
