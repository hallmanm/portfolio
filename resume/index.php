...
<div class="section">
  <h2>Summary</h2>
  <p>Data-driven Engineering Manager with over a decade of experience in the ecommerce industry. Proven ability to lead and manage teams, deliver high-quality user experiences, and drive business results. Expertise in experimentation, personalization, headless CMS, front-end development, event tracking, 3rd party integrations and tag management.</p>
</div>
<div class="section">
  <h2>Experience</h2>
  <div class="sub-section">
    ...
    <div class="group">
      ...
      <ul>
        ...
        <li>Aligning the experimentation integration to best suit the current tech stack as well as our future vision</li>
      </ul>
    </div>
  </div>
  <div class="sub-section">
    ...
    <div class="group">
      ...
      <ul>
        ...
        <li>Architect content relationships within headless CMS (Contentstack)</li>
      ...
      <ul>
        ...
        <li>Resource management for 6 project teams comprised of 30+ contractors</li>
        <li>Oversee career progression and goal development for 4 full-time direct reports</li>
        <li>Facilitate relationships with third party vendors and staffing agencies</li>
        <li>Provide feedback on project feasibility, level of effort, timing and implementation</li>
        <li>Created the UI Engineering internship program which was then used by HR as an example for other departments</li>
        <li>Oversee the template creation for marketing and transactional emails leveraging SendGrid and Bloomreach</li>
      </ul>
    </div>
    ...
    <div class="group">
      ...
      <ul>
        ...
        <li>Leveraged GCP to power “Mystery Events” which provides personalized promotional offers to customers</li>
        <li>Ranked in Top 100 Retail Personalization Index by SailThru for personalization features</li>
        <li>Created the Analytics and Web Optimization team focusing on AB testing, personalization, analytics tracking, 3rd party integrations and tag management</li>
        <li>Streamlined Universal Data Object powering our tag management and Google Analytics while also refactoring event tracking resulting in more consistent data</li>
        <li>Designed and implemented the architecture for Tealium iQ libraries and profiles providing us increased efficiency not only within AEO but also our ancillary sites and 3rd party integrations</li>
        <li>Conducted knowledge transfer sessions to delegate tag management responsibilities</li>
      </ul>
    </div>
    <div class="group">
      ...
      <ul>
        ...
        <li>Provided on-call support for engineering department</li>
        <li>Facilitated End of Year reviews for engineers</li>
      </ul>
    </div>
    <div class="group">
      ...
      <ul>
        ...
        <li>Leveraged PanoVR framework to create a shoppable interactive panoramic product guide</li>
        <li>Mentored fellow engineers</li>
      </ul>
    </div>
    <div class="group">
  ...
  <div class="sub-section">
    ...
    <div class="group">
      ...
      <ul>
        ...
        <li>Created the first mobile site for Duquesne University</li>
        <li>Developed a program to renumber incorrectly digitized books saving countless hours of manual work</li>
      </ul>
    </div>
  </div>
  <div class="sub-section">
    ...
    <div class="group">
      ...
      <span class="location">-Remote</span>
      <ul>
        <li>Developed a training program application leveraging JSON and PHP that allowed the business user to upload training videos and documents, create an evaluation and receive the results through email</li>
        <li>Created a small image management system leveraging PHP which would dynamically create galleries as well as automatically resize a copy of the images for thumbnails in an effort to increase site speed</li>
        <li>Designed and developed a music player and portfolio using HTML5, CSS3 and Javascript</li>
      </ul>
    </div>
  </div>
</div>
...
<div class="section">
  ...
  <div class="row">
    <div class="cert col-sm-6 col-md-4"><img src="/images/certs/iQCert_Hallman.jpg"/></div>
    <div class="cert col-sm-6 col-md-4"><img src="/images/certs/iQCert_Hallman_adv.jpg"/></div>
    <div class="cert col-sm-6 col-md-4"><img src="/images/certs/iQCert_Hallman_tech.jpg"/></div>
    <div class="cert col-sm-6 col-md-4"><img src="/images/certs/oracleCert_Hallman.jpg"/></div>
    <div class="cert col-sm-6 col-md-4"><a href="https://coursera.org/share/f935ba11b7adc41deee6748b5f65e60f" target="_blank"><img src="/images/certs/googleCert_Hallman.png"/></a></div>
  </div>
</div>
  ...
  <div class="skills row">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
      ...
      <ul>
        ...
        <li>Adobe Test and Target</li>
        <li>Tealium iQ</li>
        <li>Tealium EventStream</li>
        <li>Contentstack</li>
        <li>Oracle WebCenter Sites</li>
        <li>Adobe Scene7</li>
        <li>SendGrid</li>
        <li>Jira - Atlassian</li>
        <li>Wiki - Atlassian</li>
        <li>ATG Business Control Center</li>
        <li>Bitbucket</li>
      </ul>
    </div>
    <div class="col-sm-6 col-md-4 col-lg-3">
...
<div class="section">
  ...
  <div class="education row">
    ...
    <div class="col-sm-6 col-md-4">
      <h3>California University of Pennsylvania<span class="timeframe">California, PA</span></h3>
      <ul>
        <li><b>Bachelor of Science</b></li>
        <li>Graphic Communications and Multimedia</li>
